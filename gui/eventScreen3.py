...
def setup():
    global x, bg, card, buttonA, buttonB, buttonC, buttonD
    bg = loadImage('background.png')
    card = loadImage("card_front.png")
    card.resize(800, 400)
    buttonA = range(0, 100)
    buttonB = range(0, 50)
    buttonC = range(150, 250)
...
def draw():
    ...
    text("A fire purged thine crops. \nFor the next 3 turns, thou shall not receive wheat at the farm.", 705, 475)
