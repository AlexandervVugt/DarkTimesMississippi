...
def setup():
    global x, bg, wood, woodsmall, woodsmalldark, squarestroke, squarestrokedark, font, li, buttonA, buttonB, buttonC, buttonD, buttonE, buttonF
    x = 0
    ...
    squarestroke = loadImage("squarestroke.png")
    squarestroke.resize(100, 50)
    squarestrokedark = loadImage("squarestrokedark.png")
    squarestrokedark.resize(100, 50)
    ...
    buttonA = range(0, 100)
    buttonB = range(0, 50)
    buttonC = range(885, 985)
    buttonD = range(645, 695)
    buttonE = range(395, 495)
...
def draw():
    ...
    if x < 2:
        image(squarestroke, 885, 645)
        fill(255, 225, 22)
        textSize(25)
        text('NEXT', 898, 680)
        if ((mouseX in buttonC) and (mouseY in buttonD)):
            image(squarestrokedark, 885, 645)
            fill(237, 206, 0)
            textSize(25)
            text('NEXT', 898, 680)
    
    if x > 0:
        image(squarestroke, 395, 645)
        fill(255, 225, 22)
        textSize(25)
        text('BACK', 408, 680)
        if ((mouseX in buttonE) and (mouseY in buttonF)):
            image(squarestrokedark, 395, 645)
            fill(237, 206, 0)
            textSize(25)
            text('BACK', 408, 680)
